...
public class ScriptSelection2Test {
    ...
    public void testScriptEngineFactories1() throws PersistenceException {
        ...
        */
        ...
        contentResource = context.create()
                .resource(
    ...
    public void testScriptEngineFactories2() {
        ...
        */
        ...
        Resource contentResource = context.create()
                .resource(
                        CONTENT_RESOURCE_PATH,
                        JcrConstants.JCR_PRIMARYTYPE,
                        JcrConstants.NT_UNSTRUCTURED,
    ...
    private void assertScript(
        ...
        if (expectedScripts == null || expectedScripts.length == 0) {
            ...
            assertEquals(
                    "The number of expected scripts is different than the number of collected scripts.",
            ...
            while (iterator.hasNext()) {
                assertEquals(
                        "Unexpected script order.",
                        expectedScripts[index++],
