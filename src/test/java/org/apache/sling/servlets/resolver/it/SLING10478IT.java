...
public class SLING10478IT extends ServletResolverTestSupport {
    ...
    protected SlingHttpServletResponse createMockSlingHttpServletResponse() {
        final SlingHttpServletResponse response = Builders.newResponseBuilder().build();
    ...
    void checkErrorHandlerServlet(String path) throws Exception, InvocationTargetException {
        try {
            final SlingHttpServletResponse response = executeRequest(M_GET, path, HttpServletResponse.SC_NOT_FOUND);
            final String output = ((SlingHttpServletResponseResult)((HandleErrorMockSlingHttpServletResponse)response).getResponse()).getOutputAsString();
   ...
   /**
     ...
     */
    private static final class HandleErrorMockSlingHttpServletResponse extends SlingHttpServletResponseWrapper {

        private HandleErrorResponseWriter writer = null;

        public HandleErrorMockSlingHttpServletResponse(final SlingHttpServletResponse r) {
            super(r);
        }
